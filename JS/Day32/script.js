const restaurants = [
  ...
  function getrestaurant(restaurants){
    ...
    restaurants.forEach(restaurant => {
        ...
        image.src = `./Images/${restaurant.images}.jpeg`;
        ...
        price_for_two.textContent = `₹${restaurant.priceForTwo} for two`;

        cardFooter.appendChild(food);
        cardFooter.appendChild(price_for_two);
        ...
        cardContent.appendChild(card_location);
  ...
  document.getElementById('alcohol').addEventListener('click',()=>{
    const root = document.getElementById('root');
    const result = restaurants.filter((obj)=>obj.Alchol);
    root.innerHTML = "";
